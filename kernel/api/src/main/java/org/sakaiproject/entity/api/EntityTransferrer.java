...
public interface EntityTransferrer {
    ...
    default void transferCopyEntities(String fromContext, String toContext, List<String> ids) {
    }

    default void transferCopyEntities(String fromContext, String toContext, List<String> ids, boolean cleanup) {
    }
     ...
     */
    default Map<String, String> transferCopyEntities(String fromContext, String toContext, List<String> ids, List<String> transferOptions) {
        return null;
    }
