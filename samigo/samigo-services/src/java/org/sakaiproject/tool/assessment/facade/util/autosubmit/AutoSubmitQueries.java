			...
			Map toGradebookPublishedAssessmentSiteIdMap, GradebookServiceHelper gbsHelper, GradebookExternalAssessmentService g)
	{
		...
		{	
			...
			if (autoSubmit) // if we get this far and have autosubmitted, log and notify
			{
				...
				EventTrackingService.post(EventTrackingService.newEvent("sam.assessmentAutoSubmitted", notiValues.toString(), AgentFacade.getCurrentSiteId(), false, SamigoConstants.NOTI_EVENT_ASSESSMENT_SUBMITTED));
			}
		}
		catch (Exception e)
		{
