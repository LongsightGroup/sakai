 ...
 *         &lt;element name="loginCookie" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "", propOrder = { "securityPassword", "loginCookie",
		"cookieDomain" })
@XmlRootElement(name = "AuthenticateCookie")
public class AuthenticateCookie {
	...
	/**
	 * Gets the value of the loginCookie property.
	 * 
	 * @return possible object is {@link String }
	 * 
	 */
	...
	/**
	 * Sets the value of the loginCookie property.
	 * 
	 * @param value
	 *            allowed object is {@link String }
	 * 
