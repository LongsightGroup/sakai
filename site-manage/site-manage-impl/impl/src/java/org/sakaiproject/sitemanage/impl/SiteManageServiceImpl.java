                        ...
                        transactionTemplate.execute(new TransactionCallbackWithoutResult() {
                            ...
                            protected void doInTransactionWithoutResult(TransactionStatus status) {
                                ...
                                if (entityMap != null) {
                                    ...
                                    // TODO: this is temporary and allows contrib tools to remain using the old style
                                    // interface without the tool options. Master code and contrib tools should be modified
                                    // to use the new, combined interface.
